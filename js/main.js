/* Pinta el índice de unidades y sesiones en index.html.
   Lee data/curso.json (solo estructura) y luego un archivo por
   sesión en data/sesiones/<id>.json (contenido completo). */
...
async function cargarIndice() {
    ...
    try {
      ...
      for (let indiceUnidad = 0; indiceUnidad < unidades.length; indiceUnidad++) {
            ...
            // Cargamos cada sesión de la unidad (en paralelo) y las pintamos
